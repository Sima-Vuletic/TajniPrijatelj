    ...
    try:
        ...
        for i in range(br_sudionika - 1):
            pywhatkit.sendwhatmsg("+" + imenik[i][1],
                                  ...
                                  sat, minuta)
            minuta += 2  # kako bi funkcionirao kod poruke moraju biti dvije minute u razmaku
...
create_button.grid(row=1, columnspan=2, padx=10, pady=10)
...
tk.Label(root, text="Minuta slanja poruke(barem dvije minute od sada):", background="lightblue1").grid(row=4, column=0, padx=10, pady=10)
